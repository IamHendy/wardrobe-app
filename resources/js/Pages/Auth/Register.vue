    ...
    <form @submit.prevent="submit">
      ...
      <div>
        <p class="text-slate-600 mb-2">
          Already a user? <a :href="route('login')" class="text-pink-500">Login</a>
        </p>
        <button class="primary-btn bg-gradient-to-r from-pink-500 to-black text-white" :disabled="form.processing">Register</button>
      </div>
    </form>
  </div>
</template>